...
void ABTSPlayerController::SetupInputComponent()
{
	...
	BTSInputComponent->BindAction(LookAction, ETriggerEvent::Triggered , this, &ABTSPlayerController::Look);
...
void ABTSPlayerController::Look(const FInputActionValue& InputActionValue)
{
	const FVector2D Axis = InputActionValue.Get<FVector2D>();
